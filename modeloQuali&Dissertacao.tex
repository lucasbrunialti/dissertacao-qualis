...
% Os SRs baseados em filtragem colaborativa têm a limitação de fazer recomendações com acurácia para novos usuários ou novos itens, ou seja, é difícil encontrar usuários ou itens similares caso estes tenham poucas interações ou notas 
